    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-black text-white px-6 py-12">
      <div className="max-w-5xl mx-auto flex flex-col items-center space-y-10">
        <div className="text-center space-y-4">
          <h1 className="text-5xl font-extrabold text-emerald-400 tracking-tight">AI Diet Tracking</h1>
          <p className="text-gray-400 text-lg max-w-2xl">
            Track your daily meals and let AI provide detailed feedback on calorie balance, nutrition quality, and improvements.
          </p>
        </div>
